...
const ProductPage = () => {
    ...
    return (
        ...
        <Box sx={{width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', paddingBottom: "20px",}}>
        <Box style={{backgroundColor: "red", color: "white", borderRadius: "4px", padding: "10px 20px", textAlign: "center"}}>${viewProduct.price}</Box>
        <Button size="large" color='success' variant="contained" onClick={() => setBasket([...basket, viewProduct], setCount(count + 1))}>Buy</Button>
        </Box>
        <Typography variant="p">
        Rating: 
        </Typography>
        <Rating name="half-rating-read" defaultValue={2.5} precision={0.1} value={viewProduct.rating.rate} readOnly />
        <Divider />
        </Box>
